//
//  DataPresicaoViewControllerTableViewController.m
//  Projeto Final
//
...
@interface DataPresicaoViewControllerTableViewController ()

@end

@implementation DataPresicaoViewControllerTableViewController
@synthesize tableViewNome, dataPrescicao, prescicaoData, data;
...
- (UITableViewCell *)tableView: (UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if (indexPath.section == 0) {
        dataPrescicao = [MMLabel criarObjeto:CGRectMake(115, 0, self.view.frame.size.width, 30)];
        dataPrescicao.textColor = [UIColor grayColor];
        ...
        dataPrescicao.text = [NSString stringWithFormat:@"%@",
                           [dateFormatter stringFromDate:[NSDate date]]];
        
        [cell addSubview:dataPrescicao];
...
- (void)changeDateInLabel:(id)sender{
    ...
    data = [NSDateFormatter dateFromString:dataPrescicao.text];
}
