...
@interface TituloPrescViewController ()

@end

@implementation TituloPrescViewController
@synthesize textField, prescricao, clearButton;
...
- (void)viewDidLoad {
    ...
    [self setTitle:@"Título prescrição"];
    UIBarButtonItem *saveButton = [[UIBarButtonItem alloc]initWithBarButtonSystemItem:UIBarButtonSystemItemSave target:self action:@selector(adicionar2:)];
    
    [[self navigationItem] setRightBarButtonItem:saveButton];
    
    UIBarButtonItem *cancelButton = [[UIBarButtonItem alloc]initWithBarButtonSystemItem:UIBarButtonSystemItemCancel target:self action:@selector(cancelar2:)];
...
//        [textField setDelegate:self];
        ...
        textField.text = prescricao.titulo;
...
- (void)salvar
{
    ...
    prescricao.titulo = textField.text;
    
}

- (void)cancelar2:(id)sender
{
    
    [self removerTela];
}

- (void)adicionar2:(id)sender
{
    prescricao.titulo = textField.text;
