//
//  DataOcorrenciaViewController.m
//  Projeto Final
//
...
@interface DataOcorrenciaViewController ()

@end

@implementation DataOcorrenciaViewController
@synthesize tableViewNome, dataOcorrencia, ocorrencia, data;
...
- (UITableViewCell *)tableView: (UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if (indexPath.section == 0) {
        dataOcorrencia = [MMLabel criarObjeto:CGRectMake(115, 0, self.view.frame.size.width, 30)];
        dataOcorrencia.textColor = [UIColor grayColor];
        ...
        dataOcorrencia.text = [NSString stringWithFormat:@"%@",
                              [dateFormatter stringFromDate:[NSDate date]]];
        
        [cell addSubview:dataOcorrencia];
...
- (void)changeDateInLabel:(id)sender{
    ...
    data = [NSDateFormatter dateFromString:dataOcorrencia.text];
}
