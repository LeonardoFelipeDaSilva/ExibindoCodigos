...
@interface MMSobrenomeViewController ()

@end

@implementation MMSobrenomeViewController
@synthesize sobrenomeTextField, tableViewNome, pessoa, clearButton;
...
- (UITableViewCell *)tableView: (UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if (indexPath.section == 0) {
        sobrenomeTextField = [MMTextField criarObjeto:CGRectMake(10, 0, self.view.frame.size.width-60, 30)];
        sobrenomeTextField.borderStyle = UITextBorderStyleNone;
        sobrenomeTextField.returnKeyType = UIReturnKeyDone;
        [sobrenomeTextField setDelegate:self];
        clearButton = [[UIButton alloc]init];
        clearButton.frame = CGRectMake(sobrenomeTextField.frame.origin.x + sobrenomeTextField.frame.size.width + 5, 2.5, 25, 25);
        ...
        sobrenomeTextField.text = pessoa.sobrenome;
        [cell addSubview:clearButton];
        [cell addSubview:sobrenomeTextField];
    }
    return cell;
}
...
{
    pessoa.sobrenome = sobrenomeTextField.text;
