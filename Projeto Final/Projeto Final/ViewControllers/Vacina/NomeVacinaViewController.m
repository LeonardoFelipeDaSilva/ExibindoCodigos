...
@interface NomeVacinaViewController ()

@end

@implementation NomeVacinaViewController
@synthesize nomeTexField, tableViewNome, vacina, clearButton;
...
-(CGFloat)tableView:(UITableView *)tableView heightForHeaderInSection:(NSInteger)section
{
    ...
    if (section == 1) {
        return self.tableViewNome.frame.size.height - (20+30);
    }
    return 0.0;
}
