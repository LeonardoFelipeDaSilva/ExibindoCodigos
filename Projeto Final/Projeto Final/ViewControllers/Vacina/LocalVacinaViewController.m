...
@interface LocalVacinaViewController ()

@end

@implementation LocalVacinaViewController
@synthesize tableViewNome, nomeTexField, vacina, histVacina, clearButton;
...
- (UITableViewCell *)tableView: (UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if (indexPath.section == 0) {
        ...
        nomeTexField.text = histVacina.local;
...
- (void)salvar
{
    ...
    histVacina.local = nomeTexField.text;
