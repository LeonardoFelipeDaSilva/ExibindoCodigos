//
//  LocalExameTableViewController.m
//  Projeto Final
//
...
@interface LocalExameTableViewController ()

@end

@implementation LocalExameTableViewController
@synthesize textField, exame, clearButton;
