//
//  NomeMedicoTableViewController.m
//  Projeto Final
//
...
@interface NomeMedicoTableViewController ()

@end

@implementation NomeMedicoTableViewController
@synthesize textField, exame, clearButton, medico;
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if(indexPath.section == 0)
    {
        ...
        textField.text = exame.medico.nome;
