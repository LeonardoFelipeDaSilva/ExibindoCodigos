...
@interface PlanoConvenioViewController ()

@end

@implementation PlanoConvenioViewController
...
- (UITableViewCell *)tableView: (UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if (indexPath.section == 0) {
        ...
        nomeTexField.text = convenio.plano;
...
{
    convenio.plano = nomeTexField.text;
