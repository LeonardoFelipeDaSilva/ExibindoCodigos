//
//  ValidadeConvenioViewController.m
//  Projeto Final
//
...
@interface ValidadeConvenioViewController ()

@end

@implementation ValidadeConvenioViewController
@synthesize tableViewNome, dataValidade, convenio, data;
...
- (UITableViewCell *)tableView: (UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if (indexPath.section == 0) {
        dataValidade = [MMLabel criarObjeto:CGRectMake(115, 0, self.view.frame.size.width, 30)];
        dataValidade.textColor = [UIColor grayColor];
        ...
        dataValidade.text = [NSString stringWithFormat:@"%@",
                              [dateFormatter stringFromDate:[NSDate date]]];
        
        [cell addSubview:dataValidade];
...
- (void)changeDateInLabel:(id)sender{
    ...
    data = [NSDateFormatter dateFromString:dataValidade.text];
