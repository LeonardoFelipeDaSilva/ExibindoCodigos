...
// Current date's cell
#define currentDateCircleColor [UIColor colorWithRed:11/255.0f green:96/255.0f blue:186/255.0f alpha:1]
#define currentDateTextColor [UIColor whiteColor]

// Selected date's cell
#define selectedDateCircleColor [UIColor grayColor]
#define selectedDateTextColor [UIColor colorWithRed:11/255.0f green:96/255.0f blue:186/255.0f alpha:1]
