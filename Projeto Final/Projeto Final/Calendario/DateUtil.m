...
{
    NSArray *months = [[NSArray alloc]initWithObjects:@"JANEIRO",@"FEVEREIRO",@"MARÇO",@"ABRIL",@"MAIO",@"JUNHO",@"JULHO",@"AGOSTO",@"SETEMBRO",@"OUTUBRO",@"NOVEMBRO",@"DEZEMBRO", nil];
    return [months objectAtIndex:index-1];
}

+(NSString*)getDayString:(int)index
{
    NSArray *daysInWeeks = [[NSArray alloc]initWithObjects:@"Dom",@"Seg",@"Ter",@"Qua",@"Qui",@"Sex",@"Sab", nil];
