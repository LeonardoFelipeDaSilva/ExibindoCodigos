     ...
     pagingEnabled:(BOOL)paging
{
    ...
    if (self) {
        ...
        CGRect rect = CGRectMake(0, 65, self.frame.size.width, self.frame.size.height+70);
...
- (UIViewController *) controllerAtIndex:(NSInteger) index {
    ...
    if (![controllers objectForKey:[NSString stringWithFormat:@"%li",(long)index]]) {
        ...
        CGRect rect = CGRectMake(0, 55, self.frame.size.width, self.frame.size.height - headerSize);
        ...
        UIView *rectGray = [[UILabel alloc] initWithFrame:CGRectMake(10, 35, 300, 20)];
        rectGray.backgroundColor = [UIColor grayColor];
        
        UIView *rectPurple = [[UILabel alloc] initWithFrame:CGRectMake(0, 0, 320, 30)];
        rectPurple.backgroundColor = [UIColor colorWithRed:11/255.0f green:96/255.0f blue:186/255.0f alpha:1];
        UILabel *weekLabel1 = [[UILabel alloc]initWithFrame:CGRectMake(-135, 19, self.frame.size.width, headerSize)];
        weekLabel1.font = [UIFont systemFontOfSize: desiredFontSize * headerFontRatio];
        weekLabel1.textAlignment = NSTextAlignmentCenter;
        weekLabel1.text = [NSString stringWithFormat:@"dom"];
        [weekLabel1 setFont:[UIFont fontWithName:nil size:10]];
        
        UILabel *weekLabel2 = [[UILabel alloc]initWithFrame:CGRectMake(-87-5, 19, self.frame.size.width, headerSize)];
        weekLabel2.font = [UIFont systemFontOfSize: desiredFontSize * headerFontRatio];
        weekLabel2.textAlignment = NSTextAlignmentCenter;
        weekLabel2.text = [NSString stringWithFormat:@"seg"];
        [weekLabel2 setFont:[UIFont fontWithName:nil size:10]];
        
        UILabel *weekLabel3 = [[UILabel alloc]initWithFrame:CGRectMake(-46-2, 19, self.frame.size.width, headerSize)];
        weekLabel3.font = [UIFont systemFontOfSize: desiredFontSize * headerFontRatio];
        weekLabel3.textAlignment = NSTextAlignmentCenter;
        weekLabel3.text = [NSString stringWithFormat:@"ter"];
        [weekLabel3 setFont:[UIFont fontWithName:nil size:10]];
        
        UILabel *weekLabel4 = [[UILabel alloc]initWithFrame:CGRectMake(-2, 19, self.frame.size.width, headerSize)];
        weekLabel4.font = [UIFont systemFontOfSize: desiredFontSize * headerFontRatio];
        weekLabel4.textAlignment = NSTextAlignmentCenter;
        weekLabel4.text = [NSString stringWithFormat:@"qua"];
        [weekLabel4 setFont:[UIFont fontWithName:nil size:10]];
        
        UILabel *weekLabel5 = [[UILabel alloc]initWithFrame:CGRectMake(44, 19, self.frame.size.width, headerSize)];
        weekLabel5.font = [UIFont systemFontOfSize: desiredFontSize * headerFontRatio];
        weekLabel5.textAlignment = NSTextAlignmentCenter;
        weekLabel5.text = [NSString stringWithFormat:@"qui"];
        [weekLabel5 setFont:[UIFont fontWithName:nil size:10]];
        
        UILabel *weekLabel6 = [[UILabel alloc]initWithFrame:CGRectMake(90, 19, self.frame.size.width, headerSize)];
        weekLabel6.font = [UIFont systemFontOfSize: desiredFontSize * headerFontRatio];
        weekLabel6.textAlignment = NSTextAlignmentCenter;
        weekLabel6.text = [NSString stringWithFormat:@"sex"];
        [weekLabel6 setFont:[UIFont fontWithName:nil size:10]];
        
        UILabel *weekLabel7 = [[UILabel alloc]initWithFrame:CGRectMake(135, 19, self.frame.size.width, headerSize)];
        weekLabel7.font = [UIFont systemFontOfSize: desiredFontSize * headerFontRatio];
        weekLabel7.textAlignment = NSTextAlignmentCenter;
        weekLabel7.text = [NSString stringWithFormat:@"sab"];
        [weekLabel7 setFont:[UIFont fontWithName:nil size:10]];
        
        //
        //        UIView *downLineView = [[UIView alloc] initWithFrame:CGRectMake(50, 269, self.frame.size.width+250, 1)];
        //        downLineView.backgroundColor = [UIColor redColor];
        
        
        //        UIView *sideRightLineView = [[UIView alloc]initWithFrame:CGRectMake(299, 0, 1, 200)];
        //        sideRightLineView.backgroundColor = [UIColor redColor];
        
        
        
        
        
        UILabel *monthLabel = [[UILabel alloc]initWithFrame:CGRectMake(0,-8, self.frame.size.width, headerSize)];
        ...
        //        [contr.view addSubview:sideRightLineView];
        //        [contr.view addSubview:downLineView];
        
        
        
        [contr.view addSubview:rectPurple];
        [contr.view addSubview:rectGray];
        [contr.view addSubview:weekLabel1];
        [contr.view addSubview:weekLabel2];
        [contr.view addSubview:weekLabel3];
        [contr.view addSubview:weekLabel4];
        [contr.view addSubview:weekLabel5];
        [contr.view addSubview:weekLabel6];
        [contr.view addSubview:weekLabel7];
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (indexPath.row < firstDay || indexPath.row >= firstDay + daysInMonth) {
        cell.dateLabel.hidden = cell.circleView.hidden = cell.selectedView.hidden = cell.bolinha.hidden == YES;
//        cell.sideLineView.hidden = cell.sideLineView.hidden  = cell.topLineView.hidden = NO;
        cell.dateLabel.hidden = YES;
        cell.circleView.hidden = YES;
    }
    else{
        //        cell.bolinha.hidden = YES;
        cell.topLineView.hidden = cell.dateLabel.hidden = NO;
        cell.circleView.hidden = YES;
        
        //        cell.sideLineView.hidden = YES;
        ...
        //COLOCAR METODOOOOOOOOOOOOOOOOOOOOOOOOOOOOOO RAUL
